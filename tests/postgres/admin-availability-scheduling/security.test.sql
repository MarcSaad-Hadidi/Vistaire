...
select pg_temp.assert_true(not has_sequence_privilege('anon','public.restaurants_id_seq','usage') or to_regclass('public.restaurants_id_seq') is null,'availability migration does not broaden sequence access');
