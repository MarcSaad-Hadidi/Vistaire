...
test("pixel fixture carries exact coherent current and previous analytics below the per-read cap", async () => {
  ...
  const querySecond = paginateAdminVisualFixtureRows(boundaryScoped, undefined, { offset: "1000", limit: "1000" });
  ...
  assert.equal(querySecond.contentRange, "1000-1999/6002");
  assert.deepEqual(querySecond.rows, second.rows);
