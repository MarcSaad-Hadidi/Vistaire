...
| 13 | Repartition service | `AdminServiceBreakdown`; cinq fenetres UTC | Nuit, Matin, Midi, Apres-midi, Soiree / preuve / indisponible | 450 x 215; legende sous le donut mobile | H/F/T, valeur et pourcentage, liste exacte | Segments 280 ms; focus et selection conserves; instantane en reduced motion | Mention UTC unique; crop `insights-service.png` |
