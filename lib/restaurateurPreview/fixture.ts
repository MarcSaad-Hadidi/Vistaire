...
const heatCoordinates = [
  [1, 12], [1, 19], [2, 12], [2, 19], [3, 12],
  [3, 19], [4, 12], [4, 19], [5, 12], [5, 19]
] as const;
const heatmap = (counts: number[]): PreviewHeatmapCell[] =>
  counts.map((count, index) => ({
    weekday: heatCoordinates[index][0],
    hour: heatCoordinates[index][1],
    count
  }));
...
export const RESTAURATEUR_PREVIEW_FIXTURE: RestaurateurPreviewFixture = {
  ...
  restaurant: { demo: true, name: "Maison Élyse — Démo" },
  ...
  periods: {
    "24h": period(
      ...
      [78,38,96,66,61,48,30,20,12,7,4,3], [104,313,32,14], [15,11,10,8,7,6], [112,219,116,145,144], [42,58,66,72,84,96,88,78,76,76]
    ),
    "7d": period(
      "7d",
      ...
      [500,240,610,410,370,300,170,105,65,42,28,20], [650,1950,170,90], [96,74,62,51,47,42], [204,610,1304,895,1543], [320,380,410,450,500,560,540,500,470,426]
    ),
    "30d": period(
      "30d",
      ...
      [2200,1050,2680,1810,1640,1310,760,480,300,190,125,95], [2860,8590,780,410], [420,315,270,230,205,170], [890,2740,5670,4020,6710], [1300,1500,1700,1900,2200,2500,2400,2200,2100,2230]
    )
  }
};
