...
export function AvailabilityScheduleForm({ capability, dishId, dishName }: { capability: AvailabilitySchedulingCapability; dishId?: string; dishName?: string }) {
  ...
  if (capability.kind !== "available" || !dishId) return null;
