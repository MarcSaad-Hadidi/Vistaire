...
export function AdminAvailabilityPage({ data, presentation, capability }: { data: AdminDashboardData; presentation: { restaurantName: string; publicMenuPath: string }; capability: AvailabilitySchedulingCapability }) {
